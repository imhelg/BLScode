% BLS_PARAMETERSETTINGS  User parameter initialisation for BLS
%
% SETTINGS = BLS_PARAMETERSETTINGS(parameter1, value1, parameter2, value2,...)
%
% OUTPUT ARGUMENTS:
% 
%	SETTINGS	An initialisation structure to pass to BLS
% 
% INPUT ARGUMENTS:
% 
...
% EXAMPLE:
%
%	SETTINGS = BLS_ParameterSettings('NoiseStd',0.1);
% 
% NOTES:
%
...
% MA 02110-1301 USA
%
function SETTINGS = BLS_ParameterSettings(varargin)

% Ensure arguments are supplied in pairs
% 
if rem(nargin,2)
  error('Arguments to BLS_ParameterSettings should be (property, value) pairs')
end
