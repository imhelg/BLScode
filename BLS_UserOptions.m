% BLS_USEROPTIONS  User option specification for BLS
%
% OPTIONS = BLS_USEROPTIONS(parameter1, value1, parameter2, value2,...)
%
% OUTPUT ARGUMENTS:
% 
%	OPTIONS		An options structure to pass to BLS
% 
% INPUT ARGUMENTS:
% 
...
% EXAMPLE:
%
%	OPTIONS = BLS_UserOptions('diagnosticLevel','medium',...
%				  'monitor',25,...
...
% BLS_USEROPTIONS. Any supplied property-value pairs over-ride those
% defaults.
% 
...
% MA 02110-1301 USA
%
function OPTIONS = BLS_UserOptions(varargin)

% Ensure arguments are supplied in pairs
% 
if rem(nargin,2)
  error('Arguments to BLS_UserOptions should be (property, value) pairs')
end
